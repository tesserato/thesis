\section{Using geometric properties of a signal to estimate the envelope}
...
For an arbitrary continuous function, then, a pulse would correspond to the regions between its roots; for a sinusoid, a pulse would be equal to half of its cycle. In analogy, two consecutive pulses, naturally with opposing signs, have the potential to delimitate a pseudo-cycle, as illustrated in figure \ref{fig:Pulses}. For that to be true, however, the pulses need to make part of the frontiers of the signal, as yet to be defined.
  ...
  \begin{figure}[ht!]
    \centering
      \includegraphics{./imgs/01Pulses.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/02AnalyticSignal.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/03Frontiers.pdf}
...
For each set, we multiply all pulses vertical coordinates by the average length of the pulses in the set, after having divided by the average of the pulses' amplitudes, putting both axes in the same unit $i$, related to time by the equation $i = t \ \text{FPS}$.
...
\subsection{Discrete Curvature Estimation - Equivalent Circle Approach}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/04DiscreteCurvature.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/05Curvatures.pdf}
...
Given the robustness of the method, for an average wave of a few seconds at an ordinary rate of 44100 \gls{FPS} the average of the radius values is sufficient to assure the accurate identification of the frontier. However, a curve fitting method can be used in the case of longer or ill-behaved waves. 
An example of the use of the average equivalent circle can be seen in figure \ref{fig:AvgCircle}.

\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/06AvgCircle.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/07FullFrontiers.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/08Fourier.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/10xRobustness.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/09yRobustness.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/12Comparison.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics{./imgs/13FrontiersToEnvelope.pdf}
