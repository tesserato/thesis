...
For an arbitrary continuous function, then, a pulse would correspond to the regions between its roots; for a sinusoid, a pulse would be equal to half of its cycle. In analogy, two consecutive pulses, naturally with opposing signs, have the potential to delimitate a pseudo-cycle, as illustrated in figure \ref{fig:Pulses}. For that to be true, however, the pulses need to make part of the frontiers of the signal, as yet to be defined.
  ...
  \begin{figure}[ht!]
    \centering
      \includegraphics[width=0.8\linewidth]{./imgs/envelope/01Pulses.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/02AnalyticSignal.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/03Frontiers.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.2\linewidth]{./imgs/envelope/04DiscreteCurvature.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/05Curvatures.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/06AvgCircle.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/07FullFrontiers.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/08Fourier.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/10xRobustness.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/09yRobustness.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/12Comparison.pdf}
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\linewidth]{./imgs/envelope/13FrontiersToEnvelope.pdf}
