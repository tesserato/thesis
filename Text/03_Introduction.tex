...
Humans are a creative bunch. Since the beginning of computing, even when mainframes were the only available medium, restricted to organizations with huge budgets, people found ways to develop artistic applications, like proto video games, in their (and the machine's) spare time. % TODO find citation
