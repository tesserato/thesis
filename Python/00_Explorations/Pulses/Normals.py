...
'''=========================================='''
''' Pulses area | length | amplitude vectors '''
'''=========================================='''
...
max_pos_pulses_len = np.max(pos_pulses_len)
pos_pulses_len = pos_pulses_len / max_pos_pulses_len
for p in neg_pulses:
...
max_neg_pulses_len = np.max(neg_pulses_len)
neg_pulses_len = neg_pulses_len / max_neg_pulses_len
