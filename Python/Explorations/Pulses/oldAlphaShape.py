...
for p in pos_pulses:
  pos_pulses_area_X.append((p.start - .5) / max_length)
  pos_pulses_area_Y.append(0)
  pos_pulses_area_X.append((p.start - .5) / max_length)
  pos_pulses_area_Y.append(p.y)
  pos_pulses_area_X.append((p.end - .5) / max_length)
  pos_pulses_area_Y.append(p.y)
  pos_pulses_area_X.append((p.end - .5) / max_length)
  pos_pulses_area_Y.append(0)
  ...
  x = (p.start + p.x) / max_length
  y = p.y
  pos_pulses_X.append(x)
  pos_pulses_Y.append(y)
...
for p in neg_pulses:
  neg_pulses_area_X.append((p.start - .5) / max_length)
  neg_pulses_area_Y.append(0)
  neg_pulses_area_X.append((p.start - .5) / max_length)
  neg_pulses_area_Y.append(p.y)
  neg_pulses_area_X.append((p.end - .5) / max_length)
  neg_pulses_area_Y.append(p.y)
  neg_pulses_area_X.append((p.end - .5) / max_length)
  neg_pulses_area_Y.append(0)
  ...
  neg_pulses_X.append((p.start + p.x) / max_length)
