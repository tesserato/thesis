...
max_scale = 10000000000000000000
min_scale = 1.0e-305
...
fig.update_xaxes(title_font = FONT, row=1, col=1, showline=False, showgrid=False, zeroline=False)
fig.update_yaxes(title_font = FONT, row=1, col=1, title_text="<b>Min. Amp.</b>", showline=False, showgrid=False, zerolinewidth=1, zerolinecolor="silver")
...
fig.update_xaxes(title_font = FONT, row=2, col=1, title_text="<b><i>i</i></b>", showline=False, showgrid=False, zeroline=False)
fig.update_yaxes(title_font = FONT, row=2, col=1, title_text="<b>Max. Amp.</b>", showline=False, showgrid=False, zerolinewidth=1, zerolinecolor="silver")
