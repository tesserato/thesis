...
fig.update_yaxes(row=1, col=1, title_text="Min. Amp.", showline=False, showgrid=False, zerolinewidth=1, zerolinecolor="silver")
...
fig.update_yaxes(row=2, col=1, title_text="Max. Amp.", showline=False, showgrid=False, zerolinewidth=1, zerolinecolor="silver")
