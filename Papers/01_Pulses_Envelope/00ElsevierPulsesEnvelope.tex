...
Once a radius $ \alpha $ is defined, alpha shapes exhibit the uniqueness property meaning that, for a given set of points and a given radius, only one concave hull exists. When the radius $ \alpha $ of the circle tends to infinity, concave hulls tend to the convex hulls.
