...
\begin{align} \label{eq:Envelope}
  ...
  & \textbf{w} = \textbf{e} \odot \textbf{c} \quad \therefore \quad w_i = e_i c_i \quad \forall \quad i, 0 \le i \le n-1
\end{align}
...
The present work also highlights some gaps in our current understanding and definition of temporal envelope and, in so doing, endeavors to motivate further research in this topic, that can ultimately give rise to a more mathematically sound envelope theory, especially concerning broadband waves; suggestions in this direction are also presented.
