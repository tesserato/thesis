...
for i in range(1, Xpos.size):
  ...
  npulse = W[x0 : x1]
  pospseudoCyclesY.append(npulse)
  pospseudoCyclesX.append(np.arange(npulse.size))
...
for i in range(1, Xneg.size):
  ...
  # ft = np.fft.rfft(W[x0 : x1])
  npulse = W[x0 : x1]
  negpseudoCyclesY.append(npulse)
  negpseudoCyclesX.append(np.arange(npulse.size))
...
fig.add_trace(
  go.Scatter(
    name="Pseudo-cycles (positive frontier)", # <|<|<|<|<|<|<|<|<|<|<|<|
...
fig.add_trace(
  go.Scatter(
    name="Pseudo-cycles (negative frontier)", # <|<|<|<|<|<|<|<|<|<|<|<|
