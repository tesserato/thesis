...
The result of this procedure can be seen as the additional squares and diamonds in figure \ref{fig:frontiergaps}, representing new maxima and minima, respectively, found by reanalising pulses whose period is superior to 2 mean absolute deviations from the mode of the periods distribution, both for the positive and the negative frontiers.
...
figure \ref{fig:plotXps} illustrates the behaviour of the periods as inferred by both frontiers, before and after the refinement.

\begin{figure}[ht!]
  \centering
     \includegraphics{images/04plotXps.pdf}
  \caption{Frame of occurrence of the maxima and minima of a discrete signal representing the sound of the key 33 of a grand piano before and after the refinement process.}
  \label{fig:plotXps}
\end{figure}
