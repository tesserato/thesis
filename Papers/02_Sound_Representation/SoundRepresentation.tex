...
\begin{figure}[ht!]
  \centering
    %  \includegraphics[width=0.9\linewidth]{01signalenvelope}
     \includegraphics{01signalenvelope}
...
\begin{figure}[ht!]
  \centering
    %  \includegraphics[width=0.9\linewidth]{01signalenvelope}
     \includegraphics{03pcs-alto}
    % \def\svgwidth{\linewidth}
    %\input{01signalenvelope.pdf_tex}
  \caption{Normalized pseudo-cycles superimposed as defined by the positive and negative frontiers, for the alto singer signal, and the average of all normalized pseudo-cycles.}
  \label{fig:pcalto}
\end{figure}
...
\begin{figure}[ht!]
  \centering
    %  \includegraphics[width=0.9\linewidth]{01signalenvelope}
     \includegraphics{04averagepc-alto}
    % \def\svgwidth{\linewidth}
    %\input{01signalenvelope.pdf_tex}
  \caption{Average pseudo-cycles, superimposed, after a change of phase of $-\pi$ on the average pseudo-cycle defined by the negative frontier.}
  \label{fig:averagepc-alto}
\end{figure}

Figure \ref{fig:averagepc-alto} makes clear that the average pseudo-cycles, as estimated by both frontiers, are in reasonable agreement, despite the evident vertical asymmetries of the underlying wave. 

This, however, is not always the case, as  
