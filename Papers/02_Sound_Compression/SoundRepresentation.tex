...
% Overview of methods
We can interpret a continuous or discrete signal, as long as it is at least pseudo periodic, as succession of waveforms, each one representing a (pseudo) cycle of the wave.


We start with an estimate of the waveform of the signal being processed.
